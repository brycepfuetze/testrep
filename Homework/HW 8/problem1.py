...
def driver():
    ...
    layout = go.Layout(title='Comparison of Interpolated and Exact Function: Lagrange',
                  height=600,
                  xaxis=dict(
                      title='x'),
                  yaxis=dict(
    ...
    data = [trace0, trace1, trace2, trace3, trace4, trace5]
    layout = go.Layout(title='Comparison of Interpolated and Exact Function: Hermite',
                  height=600,
                  xaxis=dict(
                      title='x'),
                  yaxis=dict(
    ...
    data = [trace0, trace1, trace2, trace3, trace4, trace5]
    layout = go.Layout(title='Comparison of Interpolated and Exact Function: Natural Cubic',
                  height=600,
                  xaxis=dict(
                      title='x'),
                  yaxis=dict(
    ...
    data = [trace0, trace1, trace2, trace3, trace4, trace5]
    layout = go.Layout(title='Comparison of Interpolated and Exact Function: Clamped Cubic',
                  height=600,
                  xaxis=dict(
                      title='x'),
                  yaxis=dict(
